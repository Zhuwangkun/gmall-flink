...
import com.htsc.bean.ProductStats;
import com.htsc.common.GmallConstant;
import com.htsc.utils.ClickHouseUtil;
import com.htsc.utils.DateTimeUtil;
...
//        env.getCheckpointConfig().setMinPauseBetweenCheckpoints(2000L);
        ...
        FlinkKafkaConsumer<String> favorInfoSource = MyKafkaUtil.getKafkaConsumer(favorInfoSourceTopic, groupId);
...
//        });
        ...
        productStatsWithCategory3DS.addSink(ClickHouseUtil.getClickHouseSink("insert into product_stats_210426 values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)"));
