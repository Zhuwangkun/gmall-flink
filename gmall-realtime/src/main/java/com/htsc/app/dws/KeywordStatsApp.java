...
import com.htsc.app.func.SplitFunction;
import com.htsc.bean.KeywordStats;
...
//        env.getCheckpointConfig().setMinPauseBetweenCheckpoints(2000L);
        ...
        keywordStatsDataStream.addSink(ClickHouseUtil.getClickHouseSink("insert into keyword_stats_210426(keyword,ct,source,stt,edt,ts) values(?,?,?,?,?,?)"));
